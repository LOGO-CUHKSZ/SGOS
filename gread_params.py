...
"""
best_params_dict = {
'texas': {'reaction_term':'expn_1', 'alpha_dim':'sc', 'beta_dim':'vc', 'beta_diag':True, 
...
'wisconsin': {'reaction_term':'expn_1', 'alpha_dim':'sc', 'beta_dim':'vc', 'beta_diag':True, 
...
'cornell': {'reaction_term':'expn_1', 'alpha_dim':'vc', 'beta_dim':'vc', 'beta_diag':True, 
...
'film': {'reaction_term':'expn_1', 'alpha_dim':'sc', 'beta_dim':'vc', 'beta_diag':True, 
...
'squirrel': {'reaction_term':'expn_1', 'alpha_dim':'vc', 'beta_dim':'vc', 'beta_diag':True, 
...
'chameleon': {'reaction_term':'expn_1', 'alpha_dim':'vc', 'beta_dim':'vc', 'beta_diag':True, 
...
'Cora': {'reaction_term':'expn_1', 'alpha_dim':'vc', 'beta_dim':'vc', 'beta_diag':True, 
...
'Citeseer': {'reaction_term':'expn_1', 'alpha_dim':'vc', 'beta_dim':'vc', 'beta_diag':True, 
...
'Pubmed': {'reaction_term':'expn_1', 'alpha_dim':'vc', 'beta_dim':'vc', 'beta_diag':True, 
